...
<body>
    ...
    <div id="medias-fixed">
        ...
        <div class="medias flex-center">
            ...
            <img alt="Illustration du challenge projet" id="challengeMedia" src="<?= CDNROOT ?>/assets/images/flowwi-challenge.webp">
            <img alt="Illustration du processus du projet" id="processusMedia" src="<?= CDNROOT ?>/assets/images/flowwi-processus.webp">
            <iframe id="resultatsMedia" title="<?= $title ?>" src="https://www.youtube-nocookie.com/embed/5_6J7Eosj7E?modestbranding=1&showinfo=0&rel=0&cc_load_policy=1&iv_load_policy=3&color=white&disablekb=1&playsinline=1"width="1920" height="1080" frameborder="0"></iframe>
    ...
    <article class="article-project" id="article">
        ...
        <section id="challenge">
            <h2>Challenge</h2>
            <img alt="Illustration du challenge projet" src="<?= CDNROOT ?>/assets/images/flowwi-challenge.webp">
        ...
        <section id="processus">
            <h2>Processus</h2>
            <img alt="Illustration du processus du projet" src="<?= CDNROOT ?>/assets/images/flowwi-processus.webp">
        ...
        <section id="resultats">
            <h2>Résultats</h2>
            <iframe title="<?= $title ?>" src="https://www.youtube-nocookie.com/embed/5_6J7Eosj7E?modestbranding=1&showinfo=0&rel=0&cc_load_policy=1&iv_load_policy=3&color=white&disablekb=1&playsinline=1"width="1920" height="1080" frameborder="0"></iframe>
