...
<body>
    ...
    <article class="article-project" id="article">
        ...
        <section id="intro">
            <h1>Flowwi</h1>
            <div class="techno">
                <?php echo file_get_contents(CDNROOT . "/assets/images/logo/php.svg"); ?>
            ...
            <p>Flowwi est une plateforme web référençant près de 900 formations allant de Bac +3 à Bac +5 en lien avec le DUT Métiers du Multimédia et de l'Internet. Ce site a été le fruit du projet tutoré de 1ère année de DUT MMI. Au sein de ce projet, j'ai été chef de projet et développeur PHP/MySQL et Javascript. J'ai partagé ce projet avec <a target="_blank" href="https://www.linkedin.com/in/m%C3%A9lodie-chan-789942195/">Mélodie Chan<?php echo file_get_contents(CDNROOT . "/assets/images/logo/external-link.svg"); ?></a>&nbsp;et&nbsp;<a target="_blank" href="https://www.linkedin.com/in/thibault-paulard-040530194">Thibault Paulard<?php echo file_get_contents(CDNROOT . "/assets/images/logo/external-link.svg"); ?></a>.</p>
        </section>
        ...
        <section id="outro">
            <p class="thank">Remerciement à&nbsp;<a href="https://www.linkedin.com/in/philippe-gambette-88759153" target="_blank">Philippe Gambette<?php echo file_get_contents(CDNROOT . "/assets/images/logo/external-link.svg"); ?></a>&nbsp;et&nbsp;<a href="https://www.linkedin.com/in/alexandre-ferraille-69116889/" target="_blank">Alexandre Ferraille<?php echo file_get_contents(CDNROOT . "/assets/images/logo/external-link.svg"); ?></a></p>
            <h2 class="redirect-project"><a href="https://flowwi.fr/" target="_blank">Voir le projet<?php echo file_get_contents(CDNROOT . "/assets/images/logo/external-link.svg"); ?></a></h2>
        </section>
