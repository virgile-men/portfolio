  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{\textit{\textbf{Réalisations du stage de 2025}} : développement d'un agent AI à l'aide de LangGraph pour de l'extraction de données PDF propulsé par des LLM open-sources}
      \resumeItemListEnd
...
\section{Compétences Techniques}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     ...
     \textbf{Outils DevOps et CI/CD}{: GitHub Actions, GitLab CI/CD, Docker, Kubernetes, Grafana} \\
     \textbf{Bases de données}{: MongoDB, PostgreSQL, SQL Server, MySQL, phpMyAdmin} \\
     \textbf{Cloud et infrastructure}{: Cloudflare, OVH, Oracle Cloud, Linux, Windows, MacOS} \\
